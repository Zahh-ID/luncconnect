const enUS = {
  ...
  onboardingScreen_p: `Your wallet is the gateway to all things Cosmos, the magical technology that makes it possible to explore web3.`,
  onboardingScreen_ctaText: `Choose Your First Wallet`,
  onboardingScreen_ctaUrl: `https://cosmos.network/ecosystem/wallets`,

  aboutScreen_heading: `About Wallets`,
  aboutScreen_a_h1: `For your digital assets`,
  aboutScreen_a_p: `Wallets let you send, receive, store, and interact with digital assets like NFTs and other Cosmos tokens.`,
  ...
  aboutScreen_ctaUrl: `https://cosmos.network/ecosystem/wallets`,
